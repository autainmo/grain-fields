...
以下为仓库当前完整预设名称索引；每个预设的简洁介绍、适配逻辑与执行规则保存在对应 reference 文件中。Skill 自动选型时读取详细库，不依赖模型记忆。

### 大颗粒重构预设
> 每个预设的简洁介绍与选型依据见 [`references/presets-grain.md`](references/presets-grain.md).

**1. 印刷 / 油墨类**
`印刷缺失`、`缺墨斑块`、`掉墨 / 脱墨`、`漏印`、`残印`、`粗网点印刷`、`超大半调网点`、`方形网点`、`菱形网点`、`线状网屏`、`双色套印颗粒`、`套色偏移`、`丝网漏墨`、`丝网印刷粗颗粒`、`孔版印刷颗粒`、`Riso 粗颗粒`、`橡皮章缺印`、`旧报纸粗网点`、`油墨堆积`、`油墨飞溅块`

**2. 像素 / 数字方块类**
`大像素化`、`超大像素块`、`低分辨率像素`、`Pixel Art 像素颗粒`、`8-bit 方块`、`16-bit 像素块`、`像素溶解`、`像素脱落`、`像素漂浮`、`像素扩散`、`像素侵蚀`、`像素重组`、`随机块采样`、`矩形采样块`、`数据块马赛克`、`JPEG块状压缩`、`视频压缩块`、`数字掉块`、`块状故障 Glitch`、`数据破损方块`、`扫描错误块`

**3. 梦幻 / 半透明颗粒类**
`梦幻方块`、`玻璃方块`、`磨砂方块`、`果冻方块`、`水晶方块`、`冰块颗粒`、`棱镜颗粒`、`彩色玻璃颗粒`、`光斑方块`、`霓虹方块`、`荧光颗粒块`、`柔焦色块颗粒`、`云雾方块`、`渐变方块`、`虹彩方块`、`乳白玻璃块`、`透明叠片颗粒`、`漂浮色块`、`虚实方格`、`光晕颗粒`

**4. 拼豆 / 手工颗粒类**
`拼豆`、`熔融拼豆`、`串珠颗粒`、`玻璃珠拼贴`、`木珠拼贴`、`陶珠拼贴`、`塑料珠颗粒`、`珍珠颗粒`、`水晶珠颗粒`、`亮片拼贴`、`珠片刺绣`、`纽扣拼贴`、`积木颗粒`、`微型积木`、`软积木块`、`拼插块`、`棋子颗粒`、`磁贴颗粒`、`彩色图钉`、`毛毡球拼贴`

**5. 马赛克 / 瓷砖类**
`方砖马赛克`、`大块马赛克`、`陶瓷马赛克`、`玻璃马赛克`、`碎瓷马赛克`、`石材马赛克`、`鹅卵石马赛克`、`拜占庭马赛克`、`金箔马赛克`、`镜面马赛克`、`六边形砖块`、`三角形马赛克`、`随机多边形马赛克`、`碎玻璃马赛克`、`彩窗玻璃`、`釉面砖颗粒`、`裂瓷拼接`

**6. 纸张 / 拼贴碎片类**
`撕纸颗粒`、`碎纸屑`、`彩纸拼贴`、`报纸碎片`、`杂志碎片`、`手工剪纸块`、`粗撕边纸块`、`纸浆颗粒`、`皱纸颗粒`、`瓦楞纸碎块`、`纸胶带颗粒`、`便签纸方块`、`票据碎片`、`邮票颗粒`、`标签拼贴`、`碎照片拼贴`、`拍立得碎片`

**7. 绘画 / 颜料大颗粒**
`厚涂颜料块`、`油画刀块`、`块状笔触`、`点彩大颗粒`、`颜料结块`、`干刷缺失块`、`海绵印迹`、`滚筒缺墨`、`喷漆大颗粒`、`油漆剥落`、`蜡笔块面`、`粉彩块面`、`炭粉块`、`彩铅碎块`、`颜料碎屑`

**8. 自然物质颗粒**
`粗砂颗粒`、`彩砂拼画`、`砾石颗粒`、`碎石拼贴`、`晶体颗粒`、`盐晶颗粒`、`糖晶颗粒`、`冰晶颗粒`、`雪块颗粒`、`矿石颗粒`、`贝壳碎片`、`珊瑚碎片`、`木屑颗粒`、`树皮碎块`、`干花颗粒`、`落叶碎片`、`种子颗粒`、`谷物颗粒`、`咖啡豆颗粒`、`软木颗粒`

**9. 纺织 / 毛绒颗粒**
`毛线团颗粒`、`粗针织颗粒`、`编织方块`、`毛毡块`、`毛毡球`、`绒球颗粒`、`布料碎片`、`牛仔碎块`、`刺绣块`、`十字绣像素`、`粗针脚颗粒`、`流苏碎片`、`蕾丝碎块`

**10. 光学 / 圆形颗粒**
`大圆点颗粒`、`波点分解`、`气泡颗粒`、`肥皂泡颗粒`、`水滴颗粒`、`露珠颗粒`、`光斑颗粒`、`六边形光斑`、`彩色光球`、`柔光圆片`、`镜面圆片`、`乳白圆片`、`透明圆片叠加`

**11. 几何大颗粒**
`大方块`、`长方块`、`圆角方块`、`大圆片`、`椭圆颗粒`、`三角颗粒`、`六边形颗粒`、`菱形颗粒`、`梯形颗粒`、`多边形颗粒`、`低多边形块`、`Voronoi晶格`、`Delaunay三角网格`、`蜂窝颗粒`、`棋盘格颗粒`、`随机格网颗粒`、`阶梯颗粒`、`条带颗粒`、`十字颗粒`、`胶囊颗粒`、`圆环颗粒`

**12. 破损 / 衰败类**
`墙皮脱落`、`油漆剥落`、`锈蚀颗粒`、`氧化铜斑块`、`烧蚀颗粒`、`烧纸孔洞`、`虫蛀孔块`、`风化颗粒`、`石膏剥落`、`混凝土崩落`、`裂纹碎块`、`龟裂块`、`腐蚀孔洞`

**13. 食物 / 糖果式颗粒**
`软糖块`、`方糖`、`糖果豆`、`巧克力块`、`彩色糖珠`、`棉花糖块`、`爆米花颗粒`、`谷物圈`、`果冻粒`、`冰糖晶体`、`巧克力豆`、`饼干碎块`、`彩色麦片`、`软糖熊颗粒`、`马卡龙块`、`糖霜颗粒`

**14. 金属 / 工业颗粒**
`金属铆钉`、`螺母颗粒`、`垫片颗粒`、`金属圆片`、`冲孔板颗粒`、`钢珠`、`轴承球`、`镜面金属片`、`拉丝铝片`、`锈铁片`、`铜片拼贴`、`金箔碎片`、`银箔碎片`、`工业网格`、`穿孔金属块`、`金属碎屑`

**15. 特殊艺术化颗粒**
`彩纸屑 Confetti`、`纸花颗粒`、`碎镜片`、`棱镜碎片`、`万花筒颗粒`、`宝石切面`、`钻石颗粒`、`碎水晶`、`全息亮片`、`CD碎片`、`亚克力片`、`树脂块`、`透明塑料片`、`泡沫颗粒`、`海绵块`、`软陶块`、`橡皮泥颗粒`、`黏土块`、`积木块`、`拼图块`、`扑克牌碎片`、`字母块`、`数字块`、`符号块`、`二维码颗粒`、`文字颗粒`、`汉字方块`、`照片缩略图颗粒`、`地图碎块`、`建筑窗格颗粒`
